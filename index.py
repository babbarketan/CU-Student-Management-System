...
main = Tk()
main.title('chandigarh university Management System')
...
Label(main, text="CHANDIGARH UNIVERSITY MANAGEMENT SYSTEM", font=headlabelfont, bg='Blue').pack(side=TOP, fill=X)
